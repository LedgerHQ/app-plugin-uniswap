...
typedef enum parameter_e {
    ...
    // Parsing V4_SWAP (0x10) - Full implementation
    INPUT_V4_SWAP_LENGTH,
    INPUT_V4_SWAP_POOL_KEY_OFFSET,
    INPUT_V4_SWAP_SWAP_PARAMS_OFFSET,
    INPUT_V4_SWAP_SETTLE_USING_BURN,
    INPUT_V4_SWAP_TAKE_CLAIMS,
    INPUT_V4_SWAP_POOL_KEY,
    INPUT_V4_SWAP_PARAMS,
